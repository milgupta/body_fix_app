...
enum Typography {
    ...
    static let onboardingQuestion = Font.system(size: 34, weight: .bold, design: .rounded)
    ...
    static let ctaButton = Font.system(size: 21, weight: .bold, design: .rounded)
    ...
    static let splashTitle = Font.system(size: 40, weight: .bold, design: .rounded)

    static let screenTitle = appHeadline
    static let screenSubtitle = Font.system(size: 18, weight: .medium, design: .rounded)
    static let navTitle = Font.system(size: 31, weight: .bold, design: .rounded)
    static let muscleCardLabel = Font.system(size: 18, weight: .semibold, design: .rounded)
